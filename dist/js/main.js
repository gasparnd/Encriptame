...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _letters__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./letters */ \"./src/utils/letters.js\");\n\n\nvar message = function message(action, TEXT_AREA) {\n  var text = TEXT_AREA.value;\n  var redirect = action === 'encrypt' ? encrypt(TEXT_AREA) : decrypt(text);\n  return redirect;\n};\n\nvar encrypt = function encrypt(TEXT_AREA) {\n  var text = TEXT_AREA.value.toLowerCase();\n  var newMessage = '';\n\n  if (checkText(text)) {\n    for (var i = 0; i <= text.length; i++) {\n      var inp = Object.keys(_letters__WEBPACK_IMPORTED_MODULE_0__[\"default\"]);\n      var out = Object.values(_letters__WEBPACK_IMPORTED_MODULE_0__[\"default\"]);\n      var LETTER = text.charAt(i);\n\n      if (validator(LETTER, inp, out)) {\n        for (var e = 0; e < inp.length; e++) {\n          if (LETTER === inp[e]) {\n            newMessage += out[e];\n          }\n        }\n      } else if (text.charAt(i) === ' ') {\n        newMessage += '|';\n      } else {\n        newMessage += LETTER;\n      }\n    }\n  }\n\n  return newMessage;\n};\n\nvar decrypt = function decrypt(text) {\n  var newMessage = '';\n\n  if (checkText(text)) {\n    for (var i = 0; i <= text.length; i++) {\n      var inp = Object.values(_letters__WEBPACK_IMPORTED_MODULE_0__[\"default\"]);\n      var out = Object.keys(_letters__WEBPACK_IMPORTED_MODULE_0__[\"default\"]);\n      var LETTER = text.charAt(i);\n\n      if (validator(LETTER, inp, out)) {\n        for (var e = 0; e < inp.length; e++) {\n          if (LETTER === inp[e]) {\n            newMessage += out[e];\n          }\n        }\n      } else if (text.charAt(i) === '|') {\n        newMessage += ' ';\n      } else {\n        newMessage += LETTER;\n      }\n    }\n  }\n\n  return newMessage;\n};\n\nvar validator = function validator(_char, inp) {\n  for (var i = 0; i < inp.length; i++) {\n    if (_char === inp[i]) {\n      return true;\n    }\n  }\n};\n\nvar checkText = function checkText(text) {\n  return text.length > 0;\n};\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (message);\n\n//# sourceURL=webpack:///./src/utils/message.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/regenerator */ \"./node_modules/@babel/runtime/regenerator/index.js\");\n/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime/helpers/asyncToGenerator */ \"./node_modules/@babel/runtime/helpers/asyncToGenerator.js\");\n/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var _message__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./message */ \"./src/utils/message.js\");\n\n\n\n\nvar showMessage = /*#__PURE__*/function () {\n  var _ref = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(ev) {\n    var action, TEXT_AREA, MessageContainer, Message;\n    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {\n      while (1) {\n        switch (_context.prev = _context.next) {\n          case 0:\n            action = ev.target.dataset.type;\n            TEXT_AREA =  false || document.getElementById('textArea');\n            MessageContainer =  false || document.getElementById('Message-container');\n            _context.next = 5;\n            return Object(_message__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(action, TEXT_AREA);\n\n          case 5:\n            Message = _context.sent;\n            MessageContainer.innerHTML = \"\\n\\t\\t<h2>Your Message is:</h2>\\n\\t\\t<p>\".concat(Message, \"</p>\\n\\t\");\n\n          case 7:\n          case \"end\":\n            return _context.stop();\n        }\n      }\n    }, _callee);\n  }));\n\n  return function showMessage(_x) {\n    return _ref.apply(this, arguments);\n  };\n}();\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (showMessage);\n\n//# sourceURL=webpack:///./src/utils/showMessage.js?");
